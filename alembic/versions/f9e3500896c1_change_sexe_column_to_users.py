"""change sexe column to users

Revision ID: f9e3500896c1
Revises: 58419261057e
Create Date: 2025-10-23 13:13:12.243621
...
revision: str = 'f9e3500896c1'
down_revision: Union[str, Sequence[str], None] = '58419261057e'
...
def downgrade() -> None:
    ...
    sa.Column('sexe', postgresql.ENUM('male', 'femme', name='sexeenum'), autoincrement=False, nullable=False),
